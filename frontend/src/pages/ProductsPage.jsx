...
const ProductsPage = () => {
  ...
  // ✅ Always destructure with safe defaults
  const {
    products = [],
  ...
  // Fetch categories and sync category param from URL
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    }, 800); // slight delay for smoother typing
  ...
  const handleSearchSubmit = (e) => {
    e.preventDefault();
    // We rely on debounce, so nothing else needed
  };
