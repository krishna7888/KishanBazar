        ...
        <div className="relative z-10 w-full">
          <div className="max-w-2xl mx-auto text-center px-4">
            ...
            <p className="text-base md:text-lg text-gray-600 mb-10">
              ...
              your table. <br className="hidden md:block" />
            ...
            {[
              {
                ...
                title: "Fresh & Local",
                text: "Get the freshest produce harvested directly from local farms.",
              },
              {
                icon: <FaUsers className="text-green-500 text-3xl" />,
                title: "Support Local Farmers",
                text: "Help sustain local agriculture and support farming families in your community.",
              },
              {
                icon: <FaShoppingBasket className="text-green-500 text-3xl" />,
                title: "Seasonal Variety",
                text: "Discover a wide variety of seasonal fruits, vegetables, and farm products.",
              },
              {
                icon: <FaHandshake className="text-green-500 text-3xl" />,
                title: "Direct Communication",
                text: "Connect directly with farmers to learn about their growing practices.",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="glass p-4 rounded-2xl text-center transition-transform duration-300 shadow-lg hover:shadow-xl"
              >
